...
@Component({
  selector: 'app-invertebrates-edit',
  templateUrl: './invertebrates-edit.component.html',
  styleUrls: ['./invertebrates-edit.component.scss']
})
export class InvertebratesEditComponent implements OnInit  {
